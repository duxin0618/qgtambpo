...
class SimpleSampler(BaseSampler):
    ...
    def random_batch_truncation_trajectory(self, batch_size=None, **kwargs):
        batch_size = batch_size or self._batch_size
        observation_keys = getattr(self.env, 'observation_keys', None)

        return self.pool.random_batch_truncation_trajectory(
            batch_size, observation_keys=observation_keys, **kwargs)

    def order_batch_truncation_trajectory(self, batch_size=None, **kwargs):
        batch_size = batch_size or self._batch_size
        observation_keys = getattr(self.env, 'observation_keys', None)

        return self.pool.order_batch_truncation_trajectory(
            batch_size, observation_keys=observation_keys, **kwargs)
